...
public class AutomationDataHandler : CaptionHubInvocable, IAsyncDataSourceHandler
{
    public AutomationDataHandler(InvocationContext invocationContext) : base(invocationContext)
    {
    }
