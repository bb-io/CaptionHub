...
public class LanguageCodeDataHandler : CaptionHubInvocable, IAsyncDataSourceHandler
{
    public LanguageCodeDataHandler(InvocationContext invocationContext) : base(invocationContext)
    {
    }
        ...
        DataSourceContext context, CancellationToken cancellationToken)
    {
        ...
        return response
            ...
            .ToDictionary(x => x.CodeAndTerritory, x => x.Name);
    }
}